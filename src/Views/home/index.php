...
<body>
    ...
    <section class="featured-destinations">
        <div class="container"> <!-- Cha của nút và swiper, sẽ được style đặc biệt -->
            ...
            <div class="swiper-button-next destination-nav-next"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#1C274C">
